    ...
    <Page size={PAGE_SIZE} style={styles.page}>
      <View style={styles.coverWrap}>
        ...
        <View style={styles.coverCard}>
          <Text style={[styles.coverLabel, { fontWeight: 700, color: '#000', fontSize: 13 }]}>
...
function DiscoveryLetterPage({ section }: { section: ReportSection }) {
  return (
    <Page size={PAGE_SIZE} style={styles.page}>
      <View style={styles.section}>
        <Text style={styles.sectionHeader}>Discovery Letter</Text>
    ...
    <Page size={PAGE_SIZE} style={styles.page}>
      <View style={styles.section}>
        ...
        {section.section_definitions ? (
          <View style={styles.definitionSummary}>
...
export function ReportPrintDocument({ report }: { report: SessionReport }) {
  ...
  return (
    <Document title={`BRET Assessment — ${report.user.name}`}>
      ...
      {discoveryLetter && <DiscoveryLetterPage section={discoveryLetter} />}
