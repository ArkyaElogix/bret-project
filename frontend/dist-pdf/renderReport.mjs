...
import { Document, Page, View as View2, Text } from "@react-pdf/renderer";
...
function PdfBarChart({ data }) {
  ...
  return /* @__PURE__ */ jsx(View, { children: /* @__PURE__ */ jsxs(Svg, { width: CHART_WIDTH, height: CHART_HEIGHT + 14, children: [
...
function PageFooter({ page }) {
  return /* @__PURE__ */ jsxs2(View2, { style: styles.pageFooter, fixed: true, children: [
    /* @__PURE__ */ jsx2(Text, { children: "BRET Assessment Report" }),
    /* @__PURE__ */ jsx2(Text, { render: ({ pageNumber, totalPages }) => `Page ${pageNumber} of ${totalPages}` })
  ] });
}
function CoverPage({ report }) {
  return /* @__PURE__ */ jsxs2(Page, { size: PAGE_SIZE, style: styles.page, children: [
    /* @__PURE__ */ jsxs2(View2, { style: styles.coverWrap, children: [
      /* @__PURE__ */ jsxs2(View2, { style: styles.coverLeftColumn, children: [
        /* @__PURE__ */ jsx2(Text, { style: styles.coverTitle, children: "BRET Behavioral Assessment" }),
        /* @__PURE__ */ jsxs2(Text, { style: styles.coverSubtitle, children: [
      ...
      /* @__PURE__ */ jsx2(View2, { style: styles.coverRightColumn, children: /* @__PURE__ */ jsxs2(View2, { style: styles.coverCard, children: [
        /* @__PURE__ */ jsxs2(Text, { style: [styles.coverLabel, { fontWeight: 700, color: "#000", fontSize: 16 }], children: [
          "Name: ",
          report.user.name
        ] }),
        /* @__PURE__ */ jsxs2(Text, { style: styles.coverMeta, children: [
          "User Type: ",
          report.user.product_type
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsx2(PageFooter, { page: 1 })
  ] });
}
function DiscoveryLetterPage({ section, report }) {
  return /* @__PURE__ */ jsxs2(Page, { size: PAGE_SIZE, style: styles.page, children: [
    /* @__PURE__ */ jsxs2(View2, { style: styles.letterLayout, children: [
      /* @__PURE__ */ jsxs2(View2, { style: styles.letterLeftColumn, children: [
        /* @__PURE__ */ jsx2(View2, { style: styles.iconPlaceholderLarge }),
        /* @__PURE__ */ jsx2(Text, { style: styles.letterTitle, children: "Discovery Letter" }),
        /* @__PURE__ */ jsx2(Text, { style: styles.letterSubtitle, children: "Reflect, recalibrate, and advance with intent." })
      ] }),
      /* @__PURE__ */ jsxs2(View2, { style: styles.letterRightColumn, children: [
        /* @__PURE__ */ jsxs2(Text, { style: styles.letterGreeting, children: [
          safeName(report.user?.name),
          ","
        ] }),
        /* @__PURE__ */ jsx2(Text, { style: styles.letterBody, children: safeSectionText(section, "Welcome to your personalized behavioral assessment.") })
      ] })
    ] }),
    /* @__PURE__ */ jsx2(PageFooter, { page: 2 })
  ] });
}
function DefinitionsPage({ section, index }) {
  ...
  return /* @__PURE__ */ jsxs2(Page, { size: PAGE_SIZE, style: styles.page, children: [
    /* @__PURE__ */ jsxs2(View2, { style: styles.sectionHeaderRow, children: [
      /* @__PURE__ */ jsx2(View2, { style: styles.iconPlaceholderSmall }),
      /* @__PURE__ */ jsx2(Text, { style: styles.sectionHeader, children: section.section_name })
    ] }),
    section.section_definitions ? /* @__PURE__ */ jsx2(View2, { style: [styles.definitionSummary, { backgroundColor: "transparent", borderLeft: "none", padding: "0 0 16px 0" }], children: /* @__PURE__ */ jsx2(Text, { style: styles.definitionSummaryText, children: section.section_definitions }) }) : null,
    /* @__PURE__ */ jsx2(View2, { style: styles.definitionsGrid, children: section.factors.map((factor, i) => /* @__PURE__ */ jsxs2(View2, { style: [styles.definitionCard, borderColors[i % borderColors.length]], children: [
      /* @__PURE__ */ jsxs2(View2, { style: styles.definitionHeaderRow, children: [
        /* @__PURE__ */ jsx2(View2, { style: styles.iconPlaceholderSmall }),
        /* @__PURE__ */ jsx2(Text, { style: styles.definitionTitle, children: factor.factor_name })
      ] }),
      /* @__PURE__ */ jsx2(Text, { style: styles.definitionText, children: factor.statement || "Definition not available." })
    ] }, i)) }),
...
function ProfilePage({ section, index }) {
  ...
  return /* @__PURE__ */ jsxs2(Page, { size: PAGE_SIZE, style: styles.page, children: [
    /* @__PURE__ */ jsxs2(View2, { style: styles.section, children: [
      /* @__PURE__ */ jsx2(Text, { style: styles.sectionHeader, children: section.section_name }),
      /* @__PURE__ */ jsxs2(View2, { style: styles.profileLayout, children: [
        /* @__PURE__ */ jsxs2(View2, { style: styles.chartColumn, children: [
        ...
        /* @__PURE__ */ jsxs2(View2, { style: styles.textColumn, children: [
          ...
          /* @__PURE__ */ jsx2(View2, { style: styles.factorList, children: factors.map((factor, i) => /* @__PURE__ */ jsxs2(View2, { style: styles.factorItem, children: [
            ...
            /* @__PURE__ */ jsx2(Text, { style: styles.factorDescription, children: factor.statement || "Description not available." })
          ] }, i)) })
        ] })
      ] })
    ] }),
...
function TakeawaysPage({ report, index }) {
  ...
  return /* @__PURE__ */ jsxs2(Fragment, { children: [
    /* @__PURE__ */ jsxs2(Page, { size: PAGE_SIZE, style: styles.page, children: [
      ...
      /* @__PURE__ */ jsxs2(View2, { style: styles.summaryCard, children: [
        /* @__PURE__ */ jsx2(Text, { style: styles.summaryCardLabel, children: "Overall Observations" }),
        /* @__PURE__ */ jsx2(Text, { style: styles.summaryCardText, children: overallObservationsText })
      ] }),
      /* @__PURE__ */ jsxs2(View2, { style: styles.obsGrid, children: [
        ...
        /* @__PURE__ */ jsxs2(View2, { style: styles.obsCard, children: [
          ...
          /* @__PURE__ */ jsx2(View2, { style: styles.roadmapRow, children: roadmapPhases.map((phase, i) => /* @__PURE__ */ jsxs2(View2, { style: [styles.roadmapPhase, phase.style], children: [
            /* @__PURE__ */ jsx2(Text, { style: styles.roadmapLabel, children: phase.label }),
            typeof phase.text === "string" ? /* @__PURE__ */ jsx2(Text, { style: styles.roadmapText, children: phase.text }) : /* @__PURE__ */ jsxs2(View2, { children: [
              phase.text.action && /* @__PURE__ */ jsxs2(Text, { style: styles.roadmapText, children: [
                "Action: ",
                phase.text.action
              ] }),
              phase.text.goal && /* @__PURE__ */ jsxs2(Text, { style: styles.roadmapText, children: [
                "Goal: ",
                phase.text.goal
              ] })
            ] })
    ...
    /* @__PURE__ */ jsxs2(Page, { size: PAGE_SIZE, style: styles.page, children: [
      /* @__PURE__ */ jsxs2(View2, { style: styles.obsGrid, children: [
        /* @__PURE__ */ jsxs2(View2, { style: styles.obsCard, children: [
          /* @__PURE__ */ jsx2(Text, { style: styles.obsCardTitle, children: "Key Takeaways & Action Plan" }),
          actionItems.map((item, i) => /* @__PURE__ */ jsxs2(Text, { style: styles.obsListItem, children: [
            "\u2013 ",
            item
          ] }, i)),
        ...
        /* @__PURE__ */ jsxs2(View2, { style: styles.obsCard, children: [
          /* @__PURE__ */ jsx2(Text, { style: styles.obsCardTitle, children: "Leadership Dynamics" }),
          leadershipItems.map((item, i) => /* @__PURE__ */ jsx2(
            View2,
            {
              style: [styles.leadershipCard, i % 2 === 0 ? styles.leadershipTeal : styles.leadershipGreen],
              children: /* @__PURE__ */ jsx2(Text, { style: styles.leadershipText, children: item })
            },
            i
          ))
        ] })
      ] }),
      /* @__PURE__ */ jsx2(PageFooter, { page: index + 1 })
    ] })
  ] });
}
function ReportPrintDocument({ report }) {
  ...
  return /* @__PURE__ */ jsxs2(Document, { title: `BRET Assessment \u2014 ${report.user.name}`, children: [
    /* @__PURE__ */ jsx2(CoverPage, { report }),
    discoveryLetter && /* @__PURE__ */ jsx2(DiscoveryLetterPage, { section: discoveryLetter, report }),
    definitionPages.map((section, i) => /* @__PURE__ */ jsx2(DefinitionsPage, { section, index: i }, `def-${i}`)),
    profilePages.map((section, i) => /* @__PURE__ */ jsx2(ProfilePage, { section, index: i }, `profile-${i}`)),
    /* @__PURE__ */ jsx2(TakeawaysPage, { report, index: 0 })
  ] });
}
...
async function main() {
  ...
  const stream = await renderToStream(/* @__PURE__ */ jsx3(ReportPrintDocument, { report: reportData }));
